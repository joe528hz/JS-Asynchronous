...
//////////////////////////////////////////////////////////////////////////////
// Running Promises in Parallel (Promise Combinator: mostly used are all and race)
...
// // Promise.allSettled (returns promise weither its successful or error)
// Promise.allSettled([
...
// // Promise.any(ES2021) (returns the first fulfilled promise, ignored the rejected promise)
// Promise.any([
//   Promise.resolve('SUCCESS'),
//   Promise.reject('ERROR'),
//   Promise.resolve('SUCCESS'),
...
TEST DATA: ['img/im g-1.jpg', 'img/img-2.jpg', 'img/img-3.jpg']. To test, turn off the 'loadNPause' function.
...
const loadAll = async function (imgsArr) {
  ...
  const imgsArray = await Promise.all(imgs);
  console.log(imgsArray);
  imgsArray.forEach(img => img.classList.add('parallel'));
};
